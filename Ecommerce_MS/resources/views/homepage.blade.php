...
<div id="carouselExampleCaptions" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="{{ asset('img/Img_carousel/carousel_img1.png') }}" class="d-block w-100 imgCustom" alt="...">
        ...
        <div class="carousel-item">
            <img src="{{ asset('img/Img_carousel/carousel_img2.jpg') }}" class="d-block w-100 imgCustom" alt="...">
            <div class="carousel-caption d-md-block">
                <h5>China mounth</h5>
        ...
        <div class="carousel-item">
            <img src="{{ asset('img/Img_carousel/carousel_img3.png') }}" class="d-block w-100 imgCustom" alt="...">
            <div class="carousel-caption d-md-block">
