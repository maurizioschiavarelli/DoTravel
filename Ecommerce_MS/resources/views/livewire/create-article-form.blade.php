...
<form wire:submit="store">
    ...
    <select class="form-select mb-3" id="category" class="@error('category') is-invalid @enderror" wire:model.blur="category">
    ...
    <button type="submit" class="btn btn-primary mb-3">Crea annuncio</button>
